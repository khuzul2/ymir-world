...
## *being extracts of the Register of Figures of Renown kept by the Letian Inquisition, with the Verdicts of the Holy Office upon each*
...
---
*Colophon.* Chapter XIV·B (late-bound). Narrator: **Frater Remigius Falx** of the Letian
Inquisition (invented framing voice; `NARRATORS.md`). Drawn from `canon/characters.md` (the whole
roster, Topramesk to San Dwayne l'Edificatore), `canon/history.md` (every date as given:
1320/1339, 1906, 2015–2030, 2550, 2563, 2600, 2817–2830, 3015–3020, 3017, 3026, the Tide
~3025–27, present 3518), `canon/magic.md` and `canon/items.md` (Oblivion and its forging
note, the Masamune = Meletskar, the Sword of Valdis, the rival Rodrigo biographies and their
monster wink, the *Vita di San Dwayne*), `canon/factions.md` (the Church's inquisitors; the Black
Dawn; the crypt-archive of heretical manuscripts — the "lowest shelves, locked not empty"),
`canon/peoples.md` and `canon/geography.md` (Inanna; Aslund and the Wall); in the margins,
`canon/secret-the-great-lie.md` and the campaign-log strata. Decisions
applied: **HIS-1** (present ≈ 3518 d.M.), **HIS-5** (the two adventurers stay unnamed — the ruled
blank space), **HIS-13** (Oblivion is Tofango's; its *making* touches Kramer — margin only),
**HIS-16/META-10** (Uglush ≠ Ugrumuulsh, staged as the historian's merged-files caution;
VonGraven ≠ VonGryffen likewise), **HARV-3** (M'Raker is future-arc material of undecided
placement — confined to the margin as proscribed pages of uncertain authority; not
player-facing). The Carrillo regnal discrepancy (Rodriguez XIII vs. Alberto V) is canon's own
recorded conflict, staged as the Office's filing problem and left unresolved. **[INVENTED]**:
Frater Remigius Falx, and "the Holy Office" as the Inquisition's formal style; every Verdict
line; the recension-and-burning custom and the under-censor's flight (the provenance); the three
shrine-swords of Valdis; the perpetual anathema-renewals; the two consultations of Obnubia; the
forty-year dispute on affliction; the thrice-failed suppression of the Dwayne cult; the seven
drafts of the struck entry; the biographical connective tissue throughout. The buried-sword tale
of Aslund follows Chapter VIII's flagged legend. The figures, their deeds, and every date are
canon.
