# XIV · A HUNTSMAN'S BOOK OF BEASTS
## *Of the beasts of Ymir, honest and otherwise; their sign, their seasons, their worth, and the ones you must not hunt*

**Being the field-book of Weck of the Long Road, huntsman-ranger sworn to Therìos, kept over forty years of walking, and bought by the Curator for the price of two good knives.**

> *Curator's note.* This is the humblest book in the Compendium and I paid the least for it: two
> good knives, from a trader in Wald who could not read it. Of Weck himself I know only what the
> pages tell — that he walked most of the world, served the Hunter god, and was still alive when
> the writing stops. My colleagues catalogue creatures; this man survived them, which is a
> different scholarship and, page for page, a sounder one. I have kept his manners. — *the Curator*

---

I write what I have seen, or what was told me by men I would trust at my back. Nothing else.
Therìos asks three things of a hunter: kill clean, waste nothing, and know what you are killing.
This book is the third thing. Read it before you need it.

### HONEST BEASTS

**Daretas.** Southern highlands, Cartosa. Six legs, ox-sized, plated like an armadillo. Sign:
broad prints in double rows, dust-wallows. Placid; carries half its weight up a scree slope and
...
insult them with entries. Take the old and the weak, leave the mothers in spring, thank the
Hunter, and the forest will feed your grandchildren. That is the whole of the law.

### MAELSTROM-TOUCHED

Storms come off the world's middle that are not weather. What they touch, changes.

**Yarhim.** Crystal crabs of the Sadhir and Cartosan coasts, blue shell like sea-glass. The small
...
> chapters of certain rival compendia. For the Marchiati, see the chapter on the Peoples. — *the
> Curator*

### DESERT KINDS — the Sadhir and the Great Erg

**Glass-Stalkers.** Crystal scorpions, near invisible. You will not see one; you will see where
the sand dimples and the heat-shimmer walks against the wind. Travel at midday when their shadows
...
**Tzil Beetles.** Salt beetles, thumb-sized, harvested by the desert folk. Worth: alchemists buy
...
than any man, six-limbed, black-bristled, plated in bone, and it sees in full dark as you see at
noon. It knows what weapons are. It leaps out of the night into the middle of a caravan, kills,
and is gone with a body before the guards turn round. Solitary, the Hunter be thanked; the worst
thing in the Erg is a mother with cubs. Do not track it. Do not avenge anyone. Leave the country.
...
**Troll.** They infest the wild lands beyond the last farms. Sign: split game bones, dung full of
hair, a smell like a flooded grave. Strong past reason, stupid past belief, and neither will
...
against worse things than trolls. Never draw on one. Never go near the nests. If one stoops low
over you and cries, something is on your trail. Thank it, and check.
...
**Fungalidi.** Fungoid flyers — picture a mouthless toad, grey and spongy, on dragonfly wings,
walking on two barbed tentacles. Damp caves and rotting forest. The skin weeps acid; the claws
carry a poison that stops your limbs while it eats; and they mend as fast as you cut — blades are
an argument with mud. Oil and fire, from upwind, or leave them their cave. Worth: alchemists want
the acid glands. Charge them accordingly.

**Slashquark.** Green pigs, wrinkle-necked, with a sucker mouth and two rows of fangs. Almost
comical in the ferns. Then the neck goes out three metres, the first fangs hold you, and the
second row rakes back and strips the flesh off the bone. They are named for the sound the victim
...
bind spirits into stone. Not game — no blood, no fear, no season. Sign, so you know to be
elsewhere: oil-drip, tracks in perfect stride that never wander, no scat, no browse. Nothing that
walks and does not eat is walking for a good reason.
...
the letter, and only to the letter. Say nothing near one that you would not sign.
...
Therìos walk it with you.

---
*Colophon.* Chapter XIV. Narrator: **Weck of the Long Road**, huntsman of Therìos (invented
framing voice; `NARRATORS.md` — the two-knives provenance, the burned valley of Wald, and all
hunting-craft of sign, season, and price are [INVENTED] colour). Creatures and rosters drawn from
`canon/bestiary.md` (Daretas, Reptoidi, Yarhim, the Sadhir kinds, the Zaar'Qrak, Helgedad's trolls
and Grandi Aquile, Fungalidi, Magres, Slashquark, Relitto, Automata, the Sovereign Demons and
their post-Tide status, the twenty Veri Draghi, Gwalgamaur, Nihoggr, the Dei-Drago, Ouroboros and
Alfheim) and `canon/cosmology.md` (the Maelstrom's Marchio and the Ibridi; Spirits, Elementals up
to the Signori, Djinn, Angels, the six Circles); margins from `canon/secret-the-great-lie.md`
(Adepti-engineered dragon-custodians; the demon prison; the Maelstrom as the Chaos-bleed). Dragon
roster per `sources/extracted/wiki/creatures-dragons.md`. Decisions applied: MAG-2 (one demon
hierarchy — Sovereigns Beyond the Circles over the six Circles), MAG-12/MAG-13 (Ouroboros above
the loyal/rogue split; "Leviathan" his type, not a twenty-first dragon), MAG-17 (the "Chaos" of
the Magres = the Maelstrom's mutation), MAG-18 (the prison-crack as a mass involuntary
manifestation — the stated exception to "none cross unsummoned").
