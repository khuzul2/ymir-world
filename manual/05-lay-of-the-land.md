...
**Eleventh of Grifone, 3516. East away; wind fair.** The **Isole d'Argento**, green and silver, and **Elendor** of the **Folletti**, the prettiest harbour on the ring. Above the town stands the **Seggio di Cristallo** — the Crystal Seat, where the Council of Peoples sits — a building like weather persuaded to stop. Every people's flag flies somewhere in that road. The little folk victual you honestly and cheat at dice in ways no marked deck accounts for; I lost four doubloons and my bosun's hat, and count both well spent.
...
Ocean, Maelstrom, the ring of regions), `canon/cosmology.md` (Tempeste Arcane, Offuscamento, the
Marchiati), `canon/history.md` (the Tide as remembered history), `canon/factions.md`,
...
**GEO-9** (Meridian an island-republic, in passing), **GEO-10** (Grande Erg / Sadhir distinct),
...
gap-fill role); the by-name *il Gorgo*; all weather.
