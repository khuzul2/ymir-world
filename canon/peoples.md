...
> The races ("Razze Pure") and cultures of Ymir. Primary sources: **Player Guide**
> pp.3–19 (races); **Cartosa Guida** pp.6–7 (regional peoples); **elfi oscuri.doc**;
...
### Xebechani
Ancient, mysterious reptilian humanoids; arguably Ymir's most technologically
advanced people. Key traits: **thermovision**, unusual **elasticity** (double
joints), a **passive/cold** affect, and they are **asexual** — they do not breed
...
- **Xion** — the priestly caste; tend the gods and rites.
- **Xattva** — ethereal, "purest and noblest"; the Xebechani *par excellence*.
...
Cartosa). After the Xebechani, the most technologically advanced race — smiths and
engineers sought everywhere; sole keepers of the secret of **Polvere Nera** (Black
Powder). *(Player Guide: "identical to those in R&C.")* Branches/related peoples:
- **Nani di Pianura (Plains Dwarves)** — descendants of dwarves who left the
  mountains; the name is a mild insult among mountain dwarves.
- **Arawak** — a dwarf people who work **stone and bone, never metal**; adorn their
  hair with gems to count their deeds and status; proud warriors who prefer death
  to capture. Their mountains hold **Shald**, a prized magical glass — expeditions
  after it rarely return. *(Cartosa)*
...
**Ssas'Kher**, whose coral walls have never been breached. Come to the surface
(e.g. to Cartosa) to trade pearls and coral, rarely for diplomacy. *(Cartosa/Player Guide)*

### Folletti (the "Little People" / Piccolo Popolo)
The smallest Pure Race. Branches:
- **Fate (Fairies)** — distrust the "Tall Folk," puzzled by dwarves, hate all
  things of the Maelstrom/Evil.
- **Gnomi (Gnomes).**
Their kingdom is in the **Isole d'Argento (Silver Isles)**, capital **Elendor** —
...
- **Elar** — elves recognised as true elves.
- **Nemyel** — elves *not* recognised; pariahs/outcasts, often deformed or mad.
- **Kelvar** — "everything else that lives": animals, monsters (a dragon, a
  manticore), and every non-elf humanoid race.
Children (a special class, the **Hyrul**) undergo a **trial** testing spirit and
magical affinity; passing makes an Elar (and may raise one's **Nath**, a rank/caste),
failing makes a Nemyel — often with terrible bodily/mental cost. Especially after
**la Marea** and the **Risonanza Magica** (Magic Resonance) cut them off further,
...
- **Ibridi (Hybrids)** — creatures of the Maelstrom, mutated by magic; the category
  covers races generally deemed malign or demon-serving. → `cosmology.md`, `bestiary.md`
- **Marchiati (the Marked)** — individuals mutated in the womb by the Maelstrom;
  bear deformities but sometimes rare magical gifts; usually killed young. → `cosmology.md`

## Regional peoples of the Cartosan south `[CANON: Cartosa Guida pp.6–7]`

- **Nkishi (Wild Orcs)** — ferociously brave; scar themselves from childhood by
  letting beasts bite them. Shamans (**Bokkor**) serve ancestor-spirits and the dark
  forest gods (**Orisha**), the fiercest of which are the **Mayombe**.
- **M'Bantha (Goblins)** — jungle-edge raiders; believe humans hold magical power
  ("**Cargo**") in their everyday objects, so they steal objects to steal the power;
...
- **Gaerwath.doc** (Dark Elf society, "Società" section referenced by elfi oscuri)
  and the full Xebechani caste/culture text are only partially mined.
- Which races are "playable" for the manual, and how to present the Rolemaster
  **R&C** references system-agnostically. → `NOTES.md`
- The **orchi** as a major people (Great Horde, Regni Belligeranti, the Grande
  Khan) deserve their own full entry once a source doc surfaces.
